...
public class AtomicRedTeamTechniques {
    ...
    private static final String SUBTECHNIQUE_ID_PATTERN = "^T[0-9]{4}\\.[0-9]{3}$";
    ...
    public static void main(String[] args) throws IOException {
        List<String> techniqueIds = crawlTechniqueIds();
    ...
    protected static List<String> crawlTechniqueIds() throws IOException {
    ...
    private static String extractTechniqueId(String fileName, Pattern idPattern) {
